    ...
    "criteria": [
        {
            ...
            "prompt": "Implement and verify deadline templates with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify responsible owner field with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-upload-prompts",
            "label": "Evidence upload prompts",
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify evidence upload prompts with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify escalation reminders with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
