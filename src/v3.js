export const v3 = {
  "productName": "Compliance Calendar Lite",
  ...
  "capabilities": [
    "Domain-specific workbench: Compliance Calendar",
    "Operational table: Recurring deadlines",
  ...
  "releaseChecklist": [
    ...
    "Deadline Coverage reaches production threshold",
    "Overdue Risk is documented with evidence",
    "Evidence Discipline has no unresolved blocker",
    "ICS compliance calendar verified",
    "Owner task CSV verified",
