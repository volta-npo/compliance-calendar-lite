...
### A minimalist calendar for recurring nonprofit and small-business administrative deadlines.
...
**Finance & Grants** · **Repo 20/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/20-compliance-calendar-lite/) · [Report an issue](https://github.com/volta-npo/20-compliance-calendar-lite/issues) · [Volta](https://voltanpo.org)
...
**Compliance Calendar Lite** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Operations students supporting nonprofits and community organizations turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Compliance misses are rarely due to complexity alone. They are due to no shared system.

### The niche

Volunteer-led nonprofits and small owner-operators.

### North-star metric

`recurring deadlines tracked before due date`
...
flowchart TD
    ...
    Evidence --> Workbench["Compliance Calendar Lite"]
    Workbench --> Score["Funding readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["ICS compliance calendar"]
    Cert --> A2["Owner task CSV"]
    Cert --> A3["Evidence log"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Deadline templates"]
        M2["Responsible owner field"]
        M3["Evidence upload prompts"]
        M4["Escalation reminders"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Compliance Calendar Lite
...
|---|---|
| **Domain workbench** | A purpose-built calendar interface for a minimalist calendar for recurring nonprofit and small-business administrative deadlines. |
...
|---:|---|---|
| 1 | **Deadline templates** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Responsible owner field** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Evidence upload prompts** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Escalation reminders** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/20-compliance-calendar-lite.git
cd 20-compliance-calendar-lite
npm test
npm start
```
